...
APP_MODULE := src/oasis/api.py
APP_PATH := oasis.api:app
...
test: $(VENV_DIR)
	...
	$(PYTEST) --cov=src/oasis --cov-report=term-missing --cov-report=html --cov-fail-under=80
	@echo "✅ Tests completed."

# Run the FastAPI application
run: $(VENV_DIR)
	@echo "🚀 Starting Oasis service..."
